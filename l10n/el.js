OC.L10N.register(
    ...
    {
    "Full text search - OpenSearch Platform" : "Πλήρης αναζήτηση κειμένου - Πλατφόρμα OpenSearch",
    "Index using OpenSearch" : "Ευρετηριοποίηση με τη χρήση OpenSearch",
    "Extension to the _Full text search_ app to communicate with OpenSearch." : "Επέκταση της εφαρμογής _Full text search_ για επικοινωνία με OpenSearch.",
